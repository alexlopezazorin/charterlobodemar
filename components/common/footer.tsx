    ...
    return (
        <footer className="bg-azul-oscuro">
            ...
            <div className="bg-azul-oscuro pl-4 pb-3 flex items-center gap-1">
                ...
                <a href="mailto:alexlopezazorin@gmail.com" className="inline-block text-white text-xs hover:-translate-y-0.5 transition-transform">alexlopezazorin@gmail.com</a>
            </div>
