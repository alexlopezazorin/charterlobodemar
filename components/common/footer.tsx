...
export default function Footer() {
    return (
        <footer>
            ...
            <div className="fixed bottom-0 left-0 w-full bg-azul-oscuro grid grid-cols-1 md:grid-cols-3 px-[10%] gap-x-[10%] gap-y-6 py-6 pb-10 md:pb-6">
                ...
                <div className="flex flex-col gap-2 font-medium text-white text-sm items-center md:items-start">
                    ...
                    <a href="/terminos-y-condiciones" className="w-fit hover:-translate-y-0.5 transition-transform">Términos y Condiciones del Servicio</a>
                    <a href="/aviso-legal" className="w-fit hover:-translate-y-0.5 transition-transform">Aviso Legal</a>
                    <a href="/politica-de-privacidad" className="w-fit hover:-translate-y-0.5 transition-transform">Política de Privacidad</a>
            ...
            <a href="https://mailto:alexlopezazorin@gmail.com" target="_blank" rel="noopener noreferrer" className="fixed bottom-2 left-0 w-full text-center md:w-fit md:left-5 md:bottom-5 md:text-left text-white text-xs hover:-translate-y-0.5 transition-transform">created by alexlopezazorin@gmail.com</a>
