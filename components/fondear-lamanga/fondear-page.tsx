  ...
  return (
    <div className="min-h-screen bg-white">
      <section className="pt-16 pb-12 px-4 md:px-8 max-w-4xl mx-auto">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-4 mt-12">¿Qué es Fondear?</h2>
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-4 mt-12">Factores Clave para un Buen Fondeo</h2>
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-xl font-bold text-gray-900 mb-3">📏 Profundidad Ideal</h3>
            <p className="text-gray-700 mb-3">La profundidad recomendada en La Manga es:</p>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-xl font-bold text-gray-900 mb-3">⛓️ Regla de la Cadena</h3>
            <p className="text-gray-700 mb-3">La relación cadena-profundidad es crítica:</p>
            <ul className="text-gray-700 space-y-2">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-xl font-bold text-gray-900 mb-3">🏞️ Tipo de Fondo</h3>
            <p className="text-gray-700 mb-3">Los mejores fondos en La Manga:</p>
            <ul className="text-gray-700 space-y-2">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-xl font-bold text-gray-900 mb-3">🌊 Protección del Viento</h3>
            <p className="text-gray-700 mb-3">Elige fondeos con protección:</p>
            <ul className="text-gray-700 space-y-2">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-4 mt-12">Los Mejores Fondeos de La Manga</h2>
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-4 mt-12">Pasos para Fondear Correctamente</h2>
        <div className="space-y-6 mb-8">
          <div className="flex gap-4">
            <div className="flex-shrink-0 text-3xl font-bold text-blue-600">1</div>
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Aproximación lenta y controlada</h3>
              <p className="text-gray-700">Aproximarse contraviento (de frente) lentamente. El velero pierde velocidad naturalmente. Usar sonda para detectar profundidad.</p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Soltar cadena progresivamente</h3>
              <p className="text-gray-700">Cuando alcances la profundidad deseada, comienza a soltar cadena mientras el barco retrocede lentamente. Patrón controla velocidad.</p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Dejar derivar para que agarre el ancla</h3>
              <p className="text-gray-700">Soltar más cadena (relación 5:1) y dejar que el barco derive en arco. El ancla se clava en el fondo. Esperar 2-3 minutos.</p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Verificar que aguanta</h3>
              <p className="text-gray-700">Revirar lentamente para crear tensión. Si la cadena está tensa y el barco no deriva hacia atrás, el ancla está bien agarrada.</p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Monitorear y relajarse</h3>
              <p className="text-gray-700">Revisar ocasionalmente que el barco no deriva (usar referencias visuales en tierra). Disfrutar del snorkel, baños, descanso.</p>
            </div>
          </div>
        </div>

        <h2 className="text-3xl font-bold text-gray-900 mb-4 mt-12">Respeto al Ecosistema Marino</h2>
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-4 mt-12">Preguntas Frecuentes sobre Fondeo</h2>
        <div className="space-y-6 mb-8">
          <div className="border-b pb-4">
            <h3 className="font-bold text-lg text-gray-900 mb-2">¿Es seguro fondear de noche?</h3>
            <p className="text-gray-700">En La Manga, sí si tomas precauciones: buenas luces de navegación, sonda activa, buen fondeo confirmado. Nuestro patrón puede hacerlo, pero es poco común en turismo.</p>
          </div>

          <div className="border-b pb-4">
            <h3 className="font-bold text-lg text-gray-900 mb-2">¿Qué hago si hay tormenta mientras fondeo?</h3>
            <p className="text-gray-700">Levantamos ancla y buscamos puerto seguro o un fondeo más protegido. La seguridad es prioridad. El patrón monitorea meteorología constantemente.</p>
          </div>

          <div className="border-b pb-4">
            <h3 className="font-bold text-lg text-gray-900 mb-2">¿Puedo fondear en cualquier lugar de La Manga?</h3>
            <p className="text-gray-700">No. Hay zonas prohibidas, canales de navegación, y áreas protegidas. El patrón conoce exactamente dónde es legal y seguro fondear.</p>
          </div>

          <div className="border-b pb-4">
            <h3 className="font-bold text-lg text-gray-900 mb-2">¿Cuánto tiempo puedo fondear?</h3>
            <p className="text-gray-700">En recorridos recreativos, fondeas 30-60 minutos por parada. En charters largos (6-8h), puedes hacer múltiples fondeos de duración variable.</p>
          </div>
        </div>
